...
# from (
#     select *, if(income>50000, "High Salary", if(income<20000, "Low Salary", "Average Salary")) as category
#     from Accounts
# ) as b
# group by category
...
# from Accounts
# union all
# select "Average Salary" as category, ifnull(sum(income>=20000 and income <= 50000),0) as accounts_count
# from Accounts
